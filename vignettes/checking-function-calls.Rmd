...
`testwhat` will recognize that the `formula` argument you specified is indeed an R formula object. It will then deparse the formula and make it robust to different orderings. This means that the following submissions pass:
