...
#' @param info  extra information to be included in the feedback message
#' (useful when writing tests in loops).
#' @param failure_msg  feedback message in case of a failed test.
#' @param success_msg  feedback message in case of a successful test.
