...
expect_is <- function(object, class, info = NULL, label = NULL,
  ...
  expect_that(object, is_a(class), info, label, failure_msg = failure_msg,
...
#' @rdname is_true
#' @inheritParams expect_that
expect_true <- function(object, info = NULL, label = NULL, failure_msg = NULL,
                        success_msg = NULL) {
  if (is.null(label)) {
    label <- find_expr("object")
  }
  expect_that(object, is_true(), info, label, failure_msg = failure_msg,
              success_msg = success_msg)
}
...
#' @rdname is_false
#' @inheritParams expect_that
expect_false <- function(object, info = NULL, label = NULL, failure_msg = NULL,
                         success_msg = NULL) {
  if (is.null(label)) {
    label <- find_expr("object")
  }
  expect_that(object, is_false(), info, label, failure_msg = failure_msg,
              success_msg = success_msg)
}
...
#' @rdname is_null
#' @inheritParams expect_that
expect_null <- function(object, info = NULL, label = NULL, failure_msg = NULL,
                        success_msg = NULL) {
  if (is.null(label)) {
    label <- find_expr("object")
  }
  expect_that(object, is_null(), info, label, failure_msg = failure_msg,
              success_msg = success_msg)
}
...
expect_equal <- function(object, expected, ..., info = NULL, label = NULL,
                         expected.label = NULL, failure_msg = NULL,
                         success_msg = NULL) {
  if (is.null(label)) {
    label <- find_expr("object")
  }
  ...
  expect_that(object, equals(expected, label = expected.label, ...),
              info = info, label = label, failure_msg = failure_msg,
              success_msg = success_msg)
}
