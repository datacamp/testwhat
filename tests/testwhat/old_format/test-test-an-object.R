...
test_call(
  ...
  passes = 
    function() {
      expect_error(test_an_object(), "argument \"name\" is missing")
    }
)

test_call(
  name = 'test_no_undefined_msg',
  msg = 'receives undefined_msg argument',
  passes = function() {
    expect_error(test_an_object("object"), "argument \"undefined_msg\" is missing")
  }
)
...
test_scenario(
  ...
  passes = list(
    function() {
      expect_fail(test_an_object("var.not_equiv", "Testing"))
...
test_scenario(
  ...
  passes = function() {
    expect_fail(test_an_object("df.equiv", "Testing", eq_condition = "equal"))
    test_an_object("df.equiv", "Testing")
    expect_fail(test_an_object("df.not_equiv", "Testing", eq_condition = "equal"))
    expect_fail(test_an_object("df.not_equiv", "Testing"))
  }
)
...
test_scenario(
  ...
  passes = function() {
    expect_fail(test_an_object("var.equal", "Testing", eq_condition = "identical"))
